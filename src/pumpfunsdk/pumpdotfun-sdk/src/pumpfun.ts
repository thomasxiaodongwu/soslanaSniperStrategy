...
export class PumpFunSDK {
  ...
  async getBuyInstructions(
    ...
    transaction.add(
      await this.program.methods
        .buy(<any>new BN(amount.toString()), <any>new BN(solAmount.toString()))
        .accounts({
  ...
  async getSellInstructions(
    ...
    transaction.add(
      await this.program.methods
        .sell(<any>new BN(amount.toString()), <any>new BN(minSolOutput.toString()))
        .accounts({
          feeRecipient: feeRecipient,
          mint: mint,
          associatedBondingCurve: associatedBondingCurve,
  ...
  async getBondingCurveAccount(mint: any, commitment = DEFAULT_COMMITMENT) {
    ...
    return BondingCurveAccount.fromBuffer(<Buffer>tokenAccount.data);
  }
